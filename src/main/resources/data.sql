...
insert into `explore_california`.tour_package (code, name) values
('BC', 'Backpack Cal'),
('CC', 'California Calm'),
...
insert into `explore_california`.tour  (tour_package_code, title, description, blurb, bullets, difficulty, duration, price, region, keywords) values
  (
    'BC',
    'Big Sur Retreat',
  ...
  insert into `explore_california`.tour_rating (tour_id, customer_id, score, comment) values
  (1, 4, 5, 'I loved it'),
...
INSERT INTO `explore_california`.security_user (id, username, password, first_name, last_name) VALUES
...
INSERT INTO `explore_california`.security_role (id, role_name, description) VALUES (1, 'ROLE_ADMIN', 'Administrator');
INSERT INTO `explore_california`.security_role (id, role_name, description) VALUES (2, 'ROLE_CSR', 'Customer Service Representative');

INSERT INTO `explore_california`.user_role(user_id, role_id) VALUES
